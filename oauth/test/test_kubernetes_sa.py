    ...
    def kubernetes_config(self):
        ...
        return {
            ...
            "KUBERNETES_SA_AUTH_CONFIG": {
                ...
                "SUPERUSER_SUBJECTS": ["system:serviceaccount:quay-operator:quay-controller"],
                "DEBUGGING": True,
            },
            "TESTING": True,
        }
...
class TestSuperuserCheck:
    ...
    def test_is_superuser_subject_true(self):
        ...
        config = {
            "KUBERNETES_SA_AUTH_CONFIG": {
                "SUPERUSER_SUBJECTS": ["system:serviceaccount:quay-operator:controller"],
            },
            "TESTING": True,
        }
        service = KubernetesServiceAccountLoginService(config)
    ...
    def test_is_superuser_subject_multiple(self):
        ...
        service = KubernetesServiceAccountLoginService(config)
        assert service.is_superuser_subject("system:serviceaccount:quay-operator:controller")
        assert service.is_superuser_subject("system:serviceaccount:admin:superadmin")
        assert not service.is_superuser_subject("system:serviceaccount:default:random")
    ...
    def test_superuser_subjects_property(self):
        """superuser_subjects property should return the configured list."""
        config = {
            "KUBERNETES_SA_AUTH_CONFIG": {
                "SUPERUSER_SUBJECTS": [
        ...
        service = KubernetesServiceAccountLoginService(config)
        assert service.superuser_subjects == [
            "system:serviceaccount:ns1:sa1",
            "system:serviceaccount:ns2:sa2",
        ]
