...
func setupAuthzTestDB(t *testing.T) *sql.DB {
	...
	statements := []string{
		...
		`INSERT INTO "user" (id, username, enabled) VALUES (1, 'acme', 1), (2, 'alice', 1), (3, 'acme+reader', 1), (4, 'acme+writer', 1), (5, 'acme+admin', 1), (6, 'acme+teamrobot', 1), (7, 'acme+orgadmin', 1), (8, 'acme+creator', 1), (9, 'disabled-org', 0), (10, 'disabled-org+creator', 1)`,
		`INSERT INTO visibility (id, name) VALUES (1, 'public'), (2, 'private')`,
		`INSERT INTO repository (id, namespace_user_id, name, visibility_id, state) VALUES (10, 1, 'private', 2, 0), (11, 1, 'public', 1, 0), (12, 9, 'public', 1, 0)`,
		...
		`INSERT INTO team (id, name, organization_id, role_id, description) VALUES (20, 'writers', 1, 3, ''), (21, 'owners', 1, 1, ''), (22, 'creators', 1, 2, ''), (23, 'disabled-creators', 9, 2, '')`,
		`INSERT INTO teammember (id, user_id, team_id) VALUES (30, 6, 20), (31, 7, 21), (32, 8, 22), (33, 10, 23)`,
...
func TestAuthorizerCanCreateRepository(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "namespace owner can create",
			principal: &auth.Principal{ID: 1, Username: "acme", Kind: auth.PrincipalUser},
			namespace: "acme",
			want:      true,
		},
		{
			name:      "creator team member can create",
