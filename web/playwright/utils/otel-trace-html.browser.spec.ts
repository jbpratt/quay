...
test('renders a subpixel-wide coverage segment as at least 1px, not 0', async ({
  page,
}) => {
...
test('opens details for a __proto__ processID trace without pollution or a script error', async ({
  page,
}) => {
...
test('keeps the failedAt marker label visible inside the horizontally scrollable waterfall', async ({
  page,
}) => {
