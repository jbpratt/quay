...
### Step 0: Load Frontend Guidelines

Activate the PatternFly frontend guidelines skill to have context about component patterns and best practices:

```
Use the Skill tool to load: patternfly-frontend-guidelines
```

This provides context on PatternFly components, React patterns, routing, and testing practices used in the Quay frontend.
