...
class OpenShiftUsers(OIDCUsers):
    ...
    def __init__(
        ...
        self._sa_token_path = service_account_token_path or DEFAULT_SA_TOKEN_PATH
    ...
    def iterate_group_members(self, group_lookup_args, page_size=None, disable_pagination=False):
        ...
        try:
            ...
            response = requests.get(group_url, headers=headers, timeout=10, verify=True)
                ...
                for username in usernames:
                    ...
                    try:
                        ...
                        user_response = requests.get(
                            user_url, headers=headers, timeout=10, verify=True
                        )
    ...
    def get_user(self, username_or_email):
        ...
        try:
            ...
            response = requests.get(user_url, headers=headers, timeout=10, verify=True)
    ...
    def query_users(self, query, limit=20):
        ...
        try:
            ...
            response = requests.get(users_url, headers=headers, timeout=30, verify=True)
